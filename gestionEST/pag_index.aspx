                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <div class="pcmButton d-flex justify-content-center">
                                                                            <dx:ASPxButton Font-Names="verdana" EnableTheming="false" CssClass="estiloBtnBuscar" Style="float: left; margin-right: 15px; background-color: #ff1049;" Width="80px" Height="30px" ID="btnDescargar" runat="server" Text="Descargar" OnClick="btnDescargar_Click" AutoPostBack="false" UseSubmitBehavior="false">
                                                                            </dx:ASPxButton>

                                                                            <dx:ASPxButton Font-Names="verdana" EnableTheming="false" CssClass="estiloBtnBuscar" Style="float: left; margin-right: 8px; background-color: #ff1049;" Width="80px" Height="30px" ID="ASPxButton2" runat="server" Text="Cerrar" AutoPostBack="false" UseSubmitBehavior="false">
